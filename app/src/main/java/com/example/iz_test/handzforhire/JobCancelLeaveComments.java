...
public class JobCancelLeaveComments extends Activity implements SimpleGestureFilter.SimpleGestureListener{
        Button b1;
        String result;
        TextView t3;
        ...
        String category1,category2,category3,category4,category5,username,average_rating;
        EditText comment;
       ...
       /* if(status.equals("lend"))
        ...
        else
        {
            ...
            rating_lay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(JobCancelLeaveComments.this,ReviewRating.class);
            ...
            handz.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(JobCancelLeaveComments.this,ProfilePage.class);
                    startActivity(i);
                    finish();
                }
            });
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            if (error instanceof TimeoutError ||error instanceof NoConnectionError) {
                                final Dialog dialog = new Dialog(JobCancelLeaveComments.this);
        ...
        private void onResponserecieved(String jsonobject, int requesttype)
        {
            ...
            try {
                ...
                {
                    Intent intent=new Intent(JobCancelLeaveComments.this,ProfilePage.class);
