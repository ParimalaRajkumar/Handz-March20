...
public class LendEditComments extends Activity implements SimpleGestureFilter.SimpleGestureListener{
        ...
        String job_id, employer_id, employee_id, rating, comments,user_id,image,profilename,lend_status;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            rating_lay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(LendEditComments.this,ReviewRating.class);
            ...
            handz.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(LendEditComments.this,LendProfilePage.class);
                    startActivity(i);
                    finish();
                }
            });
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            try {
                                ...
                                // {
                                // custom dialog
                                final Dialog dialog = new Dialog(LendEditComments.this);
        ...
        private void onResponserecieved(String jsonobject, int requesttype)
        {
            ...
            try {
                ...
                {
                    Intent intent=new Intent(LendEditComments.this,LendProfilePage.class);
